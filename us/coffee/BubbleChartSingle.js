  ...
  this.BubbleChart = (function() {
    function BubbleChart(id, data, color) {
      ...
      this.charge = function(d) {
        return -Math.pow(d.radius, 2) / 7.5;
      };
      this.friction = 0.92;
      this.vis = null;
      this.force = null;
      this.color_class = function(n) {
        return "q1-6";
      };
      this.max_range = 65;
    ...
    BubbleChart.prototype.create_circles = function(cell, data) {
      ...
      that = this;
      return this.get_bubble(cell, data).enter().append("circle").attr("r", 0).attr("class", function(d) {
    ...
    BubbleChart.prototype.display = function() {
      return this.plot(this.vis, this.data);
    };
