...
(function() {
  ...
  this.CrimeUsMap = (function(_super) {
    ...
    function CrimeUsMap(id, geometry, data, color, domain) {
      ...
      this.display = __bind(this.display, this);      CrimeUsMap.__super__.constructor.call(this, id, geometry);
      this.delay = 4000;
      this.data = data;
    ...
    CrimeUsMap.prototype.display = function() {
      ...
      this.legend = new Legend(this.enclosingContainer, (function(i) {
        return _this.allStates.color_class(_this.allStates.domain[i] - 1);
      }), this.allStates.legend_text(), 'Crime per 100,000 population', {
        x: 75,
        y: 40
      });
      this.legend.show(true);
      this.enclosingContainer.attr("class", this.allStates.colorScheme);
      color_class = function(state) {
