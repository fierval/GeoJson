...
(function() {
  ...
  this.Search = (function() {
    function Search(container, visual, mapData, processFoundItem, anchor) {
      ...
      this.create_search_box = __bind(this.create_search_box, this);      this.id = "#" + (container.removeLeadHash());
      this.visual = visual;
    ...
    Search.prototype.create_search_box = function() {
      ...
      if ($(findEntity).length < 1) {
        html = '<div class="control-group" style="left: ' + this.anchor.x + 'px; top: ' + this.anchor.y + 'px; position: relative; width: 200px" >\
        ...
        return $(findEntity).focusout(function() {
          if (_this.found != null) {
