...
(function() {
  ...
  this.UsMap = (function() {
    function UsMap(id, data) {
      ...
      this.normalize_state = __bind(this.normalize_state, this);      this.width = 960;
    ...
    UsMap.prototype.display = function() {
      ...
      }).enter().append("path").attr("d", this.path).attr("class", ".state").attr("id", function(d) {
    ...
    UsMap.prototype.create_cities = function() {
      ...
      this.svg.selectAll(".place-label").data(topojson.object(this.us, cities_collection).geometries).enter().append("text").attr("class", "place-label").attr("transform", function(d) {
